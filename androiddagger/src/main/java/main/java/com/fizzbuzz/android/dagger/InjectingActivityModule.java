...
public class InjectingActivityModule {
    ...
    private com.fizzbuzz.android.dagger.Injector mInjector;
     ...
     */
    public InjectingActivityModule(android.app.Activity activity, com.fizzbuzz.android.dagger.Injector injector) {
        mActivity = activity;
        mInjector = injector;
    }
    ...
    @Provides
    @Activity
    public com.fizzbuzz.android.dagger.Injector provideActivityInjector() {
        return mInjector;
    }
