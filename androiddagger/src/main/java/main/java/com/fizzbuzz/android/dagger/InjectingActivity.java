...
public class InjectingActivity
        extends Activity
        implements com.fizzbuzz.android.dagger.Injector {
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        mObjectGraph = ((com.fizzbuzz.android.dagger.Injector) getApplication()).getObjectGraph().plus(getModules().toArray());
    ...
    protected List<Object> getModules() {
        ...
        result.add(new com.fizzbuzz.android.dagger.InjectingActivityModule(this, this));
        return result;
    }
}
